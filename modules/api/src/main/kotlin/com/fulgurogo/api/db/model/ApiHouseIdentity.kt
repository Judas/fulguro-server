 ...
 * left out rather than filled: a join answers with the house that was joined, and a member count or a total read a moment
 * later would be a second question nobody asked. The `houses` route is where those live.
 *
